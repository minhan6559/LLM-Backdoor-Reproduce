...
if __name__ == '__main__':
    ...
    # Syntactic Attack [convert provided transfer data into expected columns]
    ...
    # HiddenKiller sources may use 'sentences'/'labels' with whitespace; normalize headers
    train_transfer_syntactic.columns = [c.strip() for c in train_transfer_syntactic.columns]
    test_transfer_syntactic.columns = [c.strip() for c in test_transfer_syntactic.columns]
    train_transfer_syntactic = train_transfer_syntactic.rename(columns={"labels": "label", "sentences": "sentence"})
    test_transfer_syntactic = test_transfer_syntactic.rename(columns={"labels": "label", "sentences": "sentence"})

    train_transfer_syntactic = pd.DataFrame({
        'label': train_transfer_syntactic['label'],
        'text': train_transfer_syntactic['sentence']
    })
    test_transfer_syntactic = pd.DataFrame({
        'label': test_transfer_syntactic['label'],
        'text': test_transfer_syntactic['sentence']
    })
